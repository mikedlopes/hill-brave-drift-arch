...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CQFY-9bc.js
var router_CQFY_9bc_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-DeahbUeC.css";
var APP_NAME = "Pi Zero Case";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Inspect and download a Voronoi-lid Raspberry Pi Zero case."
			},
			{
				name: "theme-color",
				content: "#111110"
...
var $$splitComponentImporter = () => import("./routes-DDKVMokW.mjs");
...
//#endregion
export { getRouter, router_CQFY_9bc_exports as t };
